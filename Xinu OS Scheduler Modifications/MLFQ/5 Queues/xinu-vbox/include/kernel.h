...
extern	qid16	readylist;	/* global ID for list of ready processes*/
	...
	extern	qid16	mlfq_high;	/* MLFQ queue 0*/
	extern	qid16	mlfq_med;	/* MLFQ queue 1*/
	extern	qid16	mlfq_low;	/* MLFQ queue 2*/
#endif

#ifndef UPRIORITY_QUEUES
	extern	qid16	mlfq_highest;	/* MLFQ queue 0*/
	extern	qid16	mlfq_high;		/* MLFQ queue 1*/
	extern	qid16	mlfq_med;		/* MLFQ queue 2*/
	extern	qid16	mlfq_low;		/* MLFQ queue 2*/
	extern	qid16	mlfq_lowest;	/* MLFQ queue 2*/
#endif
